  ...
  $(function () {
    if ($("#performaneLine").length) {
      ...
      var salesTopOptions = {
        ...
        legendCallback: function (chart) {
          var text = [];
          text.push(
            '<div class="chartjs-legend" style="max-width: 100px; word-wrap: break-word;"><ul>'
          );
          for (var i = 0; i < chart.data.datasets.length; i++) {
            text.push("<li style='max-width: 100px; word-wrap: break-word;'>");
            text.push(
    ...
    if ($("#marketingOverview-dark").length) {
      ...
      var marketingOverviewOptionsDark = {
        ...
        legendCallback: function (chart) {
          var text = [];
          text.push(
            '<div class="chartjs-legend style="max-width: 276px; word-wrap: break-word;""><ul>'
          );
          for (var i = 0; i < chart.data.datasets.length; i++) {
            console.log(chart.data.datasets[i]); // see what's inside the obj.
            text.push('<li class="text-muted text-small">');
            text.push(
              '<span style="background-color:' +
                chart.data.datasets[i].borderColor +
                '"; max-width: 276px; word-wrap: break-word;">' +
                "</span>"
            );
            text.push(chart.data.datasets[i].label);
            text.push("</li>");
    ...
    if ($("#doughnutChart").length) {
      ...
      var doughnutPieData = {
        ...
        labels: [
          "Avariação na utilização do sistema",
          "Dúvidas Pontuais",
          "Equívoco de utilização",
          "Instalação",
          "Instalação(Biométrico)",
          "Interno",
          "Novo Usuário",
          "Queda de Internet",
          "SAP",
